...
import { Layout, BarChart2, Search } from "lucide-react"
    ...
    return (
        <div className="relative overflow-hidden py-10">
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-4">
                ...
                A assinatura será renovada automaticamente pelo valor indicado no plano selecionado, salvo cancelamento. Cancele a qualquer momento. 
                Restrições e outras condições se aplicam. Preço, conteúdo e funcionalidades estão sujeitos a alterações.
                </p>
            </div>
        </div>
    )
