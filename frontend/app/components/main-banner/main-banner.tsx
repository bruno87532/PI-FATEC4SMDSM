...
const slides = [
  { id: 1, image: "/images/padaria.png", title: "Produtos Frescos", subtitle: "Direto dos melhores mercados" },
  { id: 2, image: "/images/acougue.png", title: "Carnes Premium", subtitle: "Qualidade garantida" },
  { id: 3, image: "/images/flv.png", title: "Frutas & Verduras", subtitle: "Sempre frescos e selecionados" },
]
      ...
      <div className="flex justify-center gap-3 mt-6">
        {slides.map((_, i) => (
          <button
            key={i}
            onClick={() => goToSlide(i)}
            className={`h-3 w-8 rounded-full transition-all duration-300 ${i === currentSlide ? "bg-green-600 shadow-lg" : "bg-gray-300 hover:bg-gray-400"
              }`}
