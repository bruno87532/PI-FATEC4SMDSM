...
export function SignUpForm({ onSuccess }: SignUpFormProps) {
  ...
  function onPasswordSubmit(data: PasswordFormValues) {
    // Aqui você criaria a conta
    console.log("Criando conta com senha:", data.password)
    onSuccess()
  }
  ...
  return (
    <div className="space-y-4 py-2 pb-4">
      {step === "email" && (
        <>
          <div className="space-y-2">
            <h3 className="text-lg font-medium">Criar uma conta</h3>
            <p className="text-sm text-muted-foreground">Digite seu email para receber um código de verificação</p>
          </div>
          <Form {...emailForm}>
      ...
      {step === "password" && (
        <>
          <div className="space-y-2">
            <h3 className="text-lg font-medium">Criar senha</h3>
